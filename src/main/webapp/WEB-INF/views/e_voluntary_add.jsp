							...
							<table>
								...
								<tbody>
									<tr>
										<!-- 관리자 -->
										<td>관리자</td>
										<td><input type="text" name="id" size="50" maxlength="50"
											value="${sessionScope.account.id}" readonly></td>
									</tr>
									<tr>
										<td>제목</td>
									...
									<tr>
										...
										<td><input type="date" id="dateFrom" name="dateFrom">
											<span> ~ </span> <input type="date" id="dateTo" name="dateTo">
										</td>
									</tr>
								</tbody>
							</table>
							<div id="admin3" align="center">
								<button type="submit" id="addVsmt">등록하기</button>
							</div>
						</form:form>
					</div>
				</article>
