					...
					<div id="reserBoard">
						...
						<form:form modelAttribute="rvo" action="${pageContext.request.contextPath}/reservationModifyResult" type="POST" id="submitModifyResult">
							...
							<ul>
								...
								<li><h3>상담사전정보 : </h3></li>
								<li style="position: absolute;"><textarea path="content" cols="70" rows="10" id="content" name="content" 
				     			style="resize:none; outline:none; position: relative; bottom: 100px;">${rvo.content}</textarea><img src="${rvo.dogImg}" alt="" style="opacity: 0"></li>
								<li>
